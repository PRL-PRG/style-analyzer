...
pub fn main() {
    ...
    execute_query!(database, style_analyzer_query::select_top_starred);
    execute_query!(database, style_analyzer_query::select_quality_projects);
    execute_query!(database, style_analyzer_query::select_random_projects);
    execute_query!(database, style_analyzer_query::select_random_projects_by_size);
    execute_query!(database, style_analyzer_query::project_locs);
    execute_query!(database, style_analyzer_query::all_projects);
    execute_query!(database, style_analyzer_query::all_projects_extended);
