...
dev.copy(pdf, file=paste0(FIGS, "/precision_vs_samples.pdf"), height=4, width=8)
dev.off()
```
...
dev.copy(pdf, file=paste0(FIGS, "/precision_and_samples_comparison.pdf"), height=4, width=8)
dev.off()
```
